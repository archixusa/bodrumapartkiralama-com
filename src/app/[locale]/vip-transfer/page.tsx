  ...
  const vehicles = [
    {
      ...
      desc: t("vehicle1Desc"),
      image:
        "https://images.unsplash.com/photo-1583061386694-e5b59f6dcb98?auto=format&fit=crop&w=1200&q=80",
    },
    {
      title: t("vehicle2Title"),
      desc: t("vehicle2Desc"),
      image:
        "https://images.unsplash.com/photo-1727713682954-a76ffe479608?auto=format&fit=crop&w=1200&q=80",
    },
    {
      title: t("vehicle3Title"),
      desc: t("vehicle3Desc"),
      image:
        "https://images.unsplash.com/photo-1598114570969-ca84171a2010?auto=format&fit=crop&w=1200&q=80",
    },
  ];
